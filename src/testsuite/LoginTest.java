...
public class LoginTest extends Base_Test {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials(){
        ...
        driver.findElement(By.id("pass")).sendKeys("12345@abc");

        //Click on ‘Sign In’ button
        driver.findElement(By.xpath("//button[@id='send2' and @class='action login primary']")).click();

        //* * Verify the ‘Welcome’ text is display
        String actualText = "Welcome, Jagruit Jadeja!";
    ...
    public void verifyTheErrorMessageWithInvalidCredentials() {
        ...
        driver.findElement(By.xpath("//input[starts-with(@id,'email')]")).sendKeys("jag@gomail.com");

        //Enter Invalid Password in Password field
        driver.findElement(By.id("pass")).sendKeys("5412312");
